...
sizeY = 270
picam2 = Picamera2()
camera_config = picam2.create_video_configuration(main={'size': (1920, 1080)}, controls={'FrameRate': 5})
...
def main():
    ...
    try:
        while True:
            ...
            resized_frame = cv2.flip(resized_frame, -1)  # Flip vertically and horizontally
